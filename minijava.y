...
%token _IS _SIGN _NUM _DOUBLE _CHAR _NCHAR _STRING _RETURN _BREAK _CONTINUE _IF _ELSE _WHILE _FOR _SWITCH _CASE _DEFAULT _COLON
%%
...
statement           : ifelse | whileloop | forloop | switchcase | breakstatement | returnstatement | assignment | idlestatement
